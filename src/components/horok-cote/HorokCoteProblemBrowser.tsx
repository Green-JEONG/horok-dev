      ...
      <section className="flex min-h-0 flex-1 flex-col">
        <div className="scrollbar-hide min-h-0 flex-1 overflow-y-auto pr-1">
          {paginatedProblems.length > 0 ? (
            ...
            <div className="flex h-full min-h-[220px] items-center justify-center rounded-[26px] border border-dashed border-slate-200 bg-slate-50 px-6 text-center">
        ...
        {selectedProblems.length > 0 ? (
          <div className="mt-5 flex items-center justify-center gap-2 border-t border-slate-100 pt-4">
            <button
              ...
              className="inline-flex size-9 items-center justify-center rounded-full border border-slate-200 text-slate-500 transition hover:border-slate-300 hover:text-slate-950 disabled:cursor-not-allowed disabled:opacity-40"
            >
